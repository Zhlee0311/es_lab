...
public class PL2303GSimpleTest extends Activity {
	...
	public Spinner PL2303G_BaudRate_spinner;
	public int PL2303G_BaudRate;
	public String PL2303G_BaudRate_str="B4800";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		PL2303G_BaudRate_spinner = (Spinner)findViewById(R.id.spinner1);
		...
		PL2303G_BaudRate_spinner.setAdapter(adapter);		
		PL2303G_BaudRate_spinner.setOnItemSelectedListener(new MyOnItemSelectedListener());
	...
	private void openUsbSerial() {
		...
		if (mSerial.isConnected()) {
			...
			String str = PL2303G_BaudRate_spinner.getSelectedItem().toString();
	...
	private void ShowPL2303G_SerialNmber() {
		...
		Log.d(TAG, "Leave ShowPL2303G_SerialNmber");	
	}//ShowPL2303G_SerialNmber
	...
	private Runnable tLoop = new Runnable() {
		public void run() {	
			...
			PL2303GDriver.BaudRate mBRate[] = {PL2303GDriver.BaudRate.B9600, PL2303GDriver.BaudRate.B19200, PL2303GDriver.BaudRate.B115200};
